...
{
	public class GrantPermission : VAdminCommand
	{
		public override string Name => "permission_grant";

		public override string Description => "Grants a permission to a role.";
		...
		public override string FormatMessage( Client caller, string[] args )
		{
			...
			return $"Granted permission '{permissionId}' to '{roleName}'";
		}
	}
}
